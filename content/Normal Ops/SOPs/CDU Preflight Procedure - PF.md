...
<div class="cl-sub">Climb/Descent Winds: FMC COMM page (CLB, DES FORECAST)</div>
<div class="cl-sub">Cruise Winds: LEGS - RTE DATA</div>
<div class="cl-sub">RTE COPY</div>
<div class="cl-sub">Mileage Check: PROG page</div>
...
> [!info|no-title]
> If gross weight CG (%MAC) is at or aft of 23.1, refer to [[Normal Ops/Supplementary Procedures/General/Aft CG Takeoff|Aft CG Takeoff]]. Real life: check CG > 30%.
