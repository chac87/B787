...
<tr><td>After the engines are at reverse idle, move the reverse thrust levers to full down.</td><td></td></tr>
<tr><td>Before taxi speed, disarm the autobrake. Use manual braking as needed.</td><td></td></tr>
<tr><td>Before turning off the runway, disconnect the autopilot.</td><td></td></tr>
<tr><td>If applicable:<br><span class="sop-tag-items">PF: "You have control"</span></td><td>If applicable:<br><span class="sop-tag-items">PM: "I have control"</span></td></tr>
</tbody></table>
</div>
