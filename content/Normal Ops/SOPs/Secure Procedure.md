...
<div class="cl-item"><strong>IRS selectors</strong><span class="cl-dots"></span><strong>OFF</strong><span class="mi-role mi-role--pm">F/O</span></div>

<div class="cl-item"><strong>BATTERY switch</strong><span class="cl-dots"></span><strong>Off</strong><span class="mi-role mi-role--pm">F/O</span></div>

<div class="cl-item"><strong>FD DOOR POWER switch</strong><span class="cl-dots"></span><strong>OFF</strong><span class="mi-role mi-role--pm">F/O</span></div>

<div class="cl-item"><strong>EMERGENCY LIGHTS switch</strong><span class="cl-dots"></span><strong>OFF</strong><span class="mi-role mi-role--pm">F/O</span></div>
...
<div class="cl-item cl-indent"><strong>ECB RDC18</strong><span class="cl-dots"></span><strong>OPEN</strong><span class="mi-role mi-role--pm">F/O</span></div>
<div class="cl-sub">Push the systems (SYS) display switch on the display select panel, then select the CB key. Open the following ECBs:</div>
<div class="cl-sub">• RDC-CROWN DOOR 4 R PRI CE4241839, and</div>
<div class="cl-sub">• RDC-CROWN DOOR 4 R SEC CE4241840</div>
...
<div class="cl-item"><strong>Aircraft EFBs</strong><span class="cl-dots"></span><strong>Shutdown</strong><span class="mi-role mi-role--both">BOTH</span></div>
...
| Item | Response | Who |
|:---|:---|:---:|
| <span class="c-green">**IRS**</span> | <span class="c-green">Off</span> | F/O |
