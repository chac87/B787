...
**Objective:** Bring the airplane down smoothly to a safe altitude, in minimum time, with the least possible passenger discomfort. **Autopilot use is recommended.**
...
**Level off at the lowest safe altitude or 10.000 ft, whichever is higher.** Lowest safe altitude = MEA, MORA, or any altitude based on terrain clearance, nav aid reception, or other applicable criteria.

If severe turbulence is encountered or expected: reduce to turbulent air penetration speed.
...
If the landing gear is used during the descent: comply with the landing gear placard speeds.

## After Level Off

- Recheck the pressurization system and evaluate the situation.
- Do **not** remove crew oxygen masks if cabin altitude remains above **10.000 ft**.
