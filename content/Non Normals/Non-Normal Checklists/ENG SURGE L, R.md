...
<div class="nnc-item"><span class="nnc-num">3</span>⚠ <strong>Thrust lever (affected side)</strong><span class="cl-dots"></span><strong>Advance slowly</strong></div>
<div class="nnc-note"><strong>Note:</strong> Run the engine at a thrust setting that keeps the ENG SURGE message blank. Do not use FMC performance predictions with an engine at reduced thrust.</div>

<div class="nnc-item"><span class="nnc-num">4</span><strong>TRANSPONDER MODE selector</strong><span class="cl-dots"></span><strong>TA ONLY</strong></div>

<div class="nnc-text"><span class="nnc-num">5</span>Do <strong>not</strong> accomplish the following checklist:</div>
...
<div class="nnc-complete">7&ensp;&ensp;Checklist Complete Except Deferred Items</div>
