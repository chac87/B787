...
<div class="nnc-condition">Condition: The engine oil pressure is low.</div>
...
<div class="nnc-item"><span class="nnc-num">2</span><strong>Thrust lever (affected side)</strong><span class="cl-dots"></span><span class="nnc-confirm">Confirm</span><strong>Retard slowly until the ENG OIL PRESS message blanks or the thrust lever is at idle</strong></div>

<div class="nnc-text"><span class="nnc-num">3</span>Do <strong>not</strong> accomplish the following checklists:</div>
<div class="nnc-sub">• AUTOTHROTTLE</div>
<div class="nnc-sub">• ENG OIL TEMP</div>

<div class="nnc-text"><span class="nnc-num">4</span></div>
<div class="nnc-step">&ensp;&ensp;Choose One:</div>

<div class="nnc-decision">ENG OIL PRESS message <strong>blanks:</strong></div>
<div class="nnc-cl">
<div class="nnc-note"><strong>Note:</strong> Run the affected engine at a thrust setting that keeps the ENG OIL PRESS message blank.</div>
<div class="nnc-note">Do not use FMC performance predictions with an engine at reduced thrust.</div>
<div class="nnc-sub-item"><strong>TRANSPONDER MODE selector</strong><span class="cl-dots"></span><strong>TA ONLY</strong></div>
<div class="nnc-goto">▶▶&ensp;Go to step 5</div>
</div>

<div class="nnc-decision">ENG OIL PRESS message <strong>stays shown:</strong></div>
<div class="nnc-cl">
<div class="nnc-sub-item"><strong>FUEL CONTROL switch (affected side)</strong><span class="cl-dots"></span><span class="nnc-confirm">Confirm</span><strong>CUTOFF</strong></div>
<div class="nnc-sub-item"><strong>APU selector (if APU available)</strong><span class="cl-dots"></span><strong>START, then ON</strong></div>
<div class="nnc-sub-item"><strong>TRANSPONDER MODE selector</strong><span class="cl-dots"></span><strong>TA ONLY</strong></div>
