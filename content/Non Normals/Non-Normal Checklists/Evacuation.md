...
<div class="nnc-note"><strong>Note:</strong> Nach Parking Brake Set: <em>"Attention Crew on Station, Attention Crew on Station!"</em></div>
<div class="nnc-item"><span class="nnc-num">2</span><strong>OUTFLOW VALVE switches (both)</strong><span class="cl-dots"></span><strong>MAN</strong><span class="mi-role mi-role--pm">F/O</span></div>
