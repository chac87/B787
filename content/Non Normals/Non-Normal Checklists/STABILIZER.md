...
# <span class="h1-bracket">[]</span> STABILIZER
...
<div class="nnc-text"><span class="nnc-num">3</span>The stabilizer is inoperative. Pitch trim is available in the normal flight control mode.</div>
...
<div class="nnc-note"><strong>Note:</strong> Use flaps 20 and v<sub>REF</sub> 30 + 20 for landing. This gives sufficient elevator authority for landing.</div>
...
<div class="nnc-complete">5&ensp;&ensp;Checklist Complete Except Deferred Items</div>
...
<div class="nnc-item"><span class="nnc-num"></span><strong>Landing data</strong><span class="cl-dots"></span><strong>v<sub>REF</sub> 30 + 20 ___ Minimums ___</strong></div>
