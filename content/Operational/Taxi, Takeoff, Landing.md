...
Rolling Takeoff empfohlen: schnellere Freigabe der Runway, geringeres FOD-Risiko, reduziertes Engine Surge-Risiko bei Crosswind.
...
**Positive Rate** wird am **Altimeter** festgestellt — nicht am VSI (unzuverlässig direkt nach Lift-off).

Flap Retraction in VNAV: automatisch auf der Höhe aus TAKEOFF REF 2/2 im FMC.

> [!info] Flap Retraction-Logik
> T/O Flap > 5: **erster Call immer Flap 5** — keine Zwischenstufen.
...
- Sofort nach Hauptfahrwerk-Aufsetzen: **Reverser auf Idle-Detent-Interlock** — noch bevor das Bugrad aufsetzt
- Bugrad: **nicht fallen lassen, aber auch nicht halten** — beides führt zu hartem Nosewheel-Aufsetzen. Gleichmäßig auf die Piste fliegen.
...
- Bei zweifelhafter Braking Action: **Geschwindigkeit deutlich reduzieren** vor dem Turnoff
