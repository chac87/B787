...
2 APU Starter/Generatoren (ASGs) · Betrieb bis zur **maximalen zertifizierten Flughöhe** · Generatorleistung nimmt mit Höhe ab.
...
**Startsequenz:** Selector → START → APUC öffnet Air Inlet Door → bei voller Öffnung + CCS bereit: Starter eingerückt → bei ausreichender Drehzahl: Zündung + Kraftstoff → Starter Cutout bei **≈ 50 % RPM** → APU betriebsbereit bei **95 % Zieldrehzahl + 2 sec**
